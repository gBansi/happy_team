...
const Logo = () => {
    ...
    return (
        <div className='my-[70px] w-[300px] md:w-full items-center justify-center'>
            <div className='flex flex-col items-center justify-center px-4 py-10'>
                ...
                <p className='text-xl text-center mt-3'>at the core of our mission, your satisfaction is our success</p>
            </div>
            <Slider {...settings}>
                {clientImages.map((image, index) => (
                    <div key={index} className='mx-auto w-[150px] h-[150px]  overflow-hidden'>
                        <img src={image.src} alt={image.alt} className='w-[150px] h-[150px] mx-auto' />
                    </div>
                ))}
            </Slider>
        </div>
