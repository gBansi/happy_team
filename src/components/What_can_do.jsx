        ...
        <div className='my-[70px]'>
            ...
            <div className='flex flex-col xl:flex-row items-start justify-center gap-2 py-10'>
                ...
                <div className="flex flex-col justify-start items-start xl:w-[40%]">
                    <img src={slide1} alt="Description" className='rounded-full sm:h-[400px] sm:w-[400px] w-[300px] h-[300px]' />
                </div>
                    ...
                    <div className="bg-white text-gray-800 p-6">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            {features.map((feature, index) => (
                                <div key={index} className="flex flex-col items-center xl:items-start text-center xl:text-start">
                                    <div className='h-fit w-fit p-2 bg-[#27BDEE]'>
                                        <feature.Icon className="text-white text-5xl hover:text-[#26173F]" />
                                    </div>
                                    <h2 className="text-xl font-bold mb-2 text-start">{feature.title}</h2>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mx-auto">
                            <img src={slide1} className='h-[100px] w-[100px] rounded-full overflow-hidden mx-auto'></img>
                            <div className='mx-auto'>
                                <h1 className='text-[#26173F] text-lg xl:text-2xl font-bold text-start'>vishnu kamaliya</h1>
